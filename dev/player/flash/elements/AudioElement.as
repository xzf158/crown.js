...
package elements 
{
	...
	*/
	public class AudioElement implements IMediaElement
	{
		...
		public function AudioElement(element:FlashMediaElement, autoplay:Boolean, preload:String, timerRate:Number, startVolume:Number, startMuted:Boolean) 
		{
			_element = element;
			_autoplay = autoplay;
			_preload = preload;
...
//		}
		...
		public function setIsPaused(paused:Boolean):void {
			// ignore if already set
			if ( (paused && _isPaused) || (!paused && !_isPaused))
				return;
