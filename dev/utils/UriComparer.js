define(['crown', 'crown.utils/Uri', 'jquery'], function (crown, Uri, $) {
    var Scheme = crown.inherit("crown.utils.UriComparer", function () { });
    Scheme.options = { ingnoreProtocol: true, ingnoreAccount: true, ingnorePort: true, ingnoreAnchor: true, ingnoreSearch: false};
