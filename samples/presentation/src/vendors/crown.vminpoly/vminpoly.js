/* jshint ignore:start */
define(['jquery', 'crown.vminpoly/tokenizer', 'crown.vminpoly/parser'], function ($, tokenizer, parser) {
  ...
  var getViewportSize, initLayoutEngine;
  ...
  initLayoutEngine = function () {
    ...
    styleElement.setAttribute('data-created-by', 'vminpoly');
    head = document.getElementsByTagName('head')[0];
    head.appendChild(styleElement);
    links = document.getElementsByTagName('link');
    $('link[rel=stylesheet].vminpoly').each(function () {
        var href = $(this).attr('href');
        $.get(href).done(function (cssText) {
            var sheet, tokenlist;

            tokenlist = tokenizer.tokenize(cssText);
            sheet = parser.parse(tokenlist);
