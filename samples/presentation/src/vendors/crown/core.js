(function (name, definition) {
    ...
    var crown = {}, objs = {};
    crown.version = "0.4";
    crown.fetch = function (sign) {
        return objs[sign];
    };
    crown.register = function (sign, obj) {
        objs[sign] = obj;
    };
    crown.inherit = function (sign, ascent) {
    ...
    crown.properties = function (obj, props) {
        for (var i = 0, il = props.length; i < il; i++) {
            crown.property(obj, props[i]);
        }
        return obj;
    };
    crown.property = function (obj, prop) {
    ...
    // crown.throttle = function (fn, delay, mustRunDelay) {
    //     var timer = null;
    //     var t_start;
    //     return function () {
