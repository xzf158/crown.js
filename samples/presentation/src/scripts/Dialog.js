define(["jquery", "crown", 'greensock/TweenMax'], function ($, crown) {
    var Scheme = crown.inherit("crown.ui.Dialog", function () { });
    ...
    proto.open = function ($content) {
        ...
        TweenMax.fromTo($content[0], 0.6, { 'z-index': 199999, opacity: 0, display: 'block' }, { opacity: 1, overwrite: 1, delay:0.2, ease: Quart.easeIn });
        TweenMax.fromTo(this.$element[0], 0.5, { display: 'block', opacity: 0 }, { opacity: 1, overwrite: 1, ease: Quart.easeIn });
    };
